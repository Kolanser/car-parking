...
from .views import CarClientCreateView, CarClientUpdateView, ParkingControlListView, ParkingEventView, ParkingListView
...
urlpatterns = [
    ...
    path("<int:parking_id>/control-cars/", ParkingControlListView.as_view(), name="parking-control-list"),
]
